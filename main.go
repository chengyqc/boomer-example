...
func foo() {
	...
	*/
	MyBoomer.RecordSuccess("http", "foo", elapsed.Nanoseconds()/int64(time.Millisecond), int64(10))
}
...
func bar() {
	...
	*/
	MyBoomer.RecordFailure("udp", "bar", elapsed.Nanoseconds()/int64(time.Millisecond), "udp error")
}
...
func main() {
	...
	MyBoomer = boomer.NewBoomer("127.0.0.1", 5557)
	MyBoomer.Run(task1, task2)
